...
parser.add_argument("--p", type=int, default=1, help="The value of p")
args = parser.parse_args()

df = pd.read_csv(f'/home/kdd1/shared_folder/UNSW/UNSW_results_stephen/final_UNSW_pequals{args.p}.csv')
